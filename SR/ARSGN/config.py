...
# Normalizzazione
NORMALIZE = 'MinMax' # Opzioni: 'MinMax' o 'Standard'

# Parametri di I/O
DATA_DIR_LR = "C:/Dati_UCMerced_LandUse/lr_train"
DATA_DIR_HR = "C:/Dati_UCMerced_LandUse/hr_train"
WEIGHTS_DIR = "SR\ARSGN\weights_fulldata_norm_" + NORMALIZE
SAVE_FREQUENCY = 20
...
# Output test
HR_PATCH_SIZE = 256 // SCALE_FACTOR
OUTPUT_DIR = "C:/Dati_UCMerced_LandUse/SR_images_norm_standard"
